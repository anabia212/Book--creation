...
Update the Docusaurus sidebar and navigation to include Module 4.

Add Module 4 with three chapters as .md files: Voice-to-Action Interfaces, Cognitive Planning with LLMs, and Capstone: The Autonomous Humanoid.
```
